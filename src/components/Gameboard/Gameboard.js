	...
	return(
		...
		<div>
			...
			<div id="gameboard">
				...
				<div className="boardsquare s7"><div id="s7div">7<div className="backSpace">Back 1</div><div className="players">{position1(7)}{position2(7)}{onPlayerLooseSpace(7, 1)}</div></div></div>
				...
				<div className="boardsquare s10"><div id="s10div">10 <div className="loseTurn">Lose Turn</div><div className="players">{position1(10)}{position2(10)}{onBothLoseTurn(10)}</div></div></div>
				<div className="boardsquare s11"><div id="s11div">11 <div className="backSpace">Back 2</div><div className="players">{position1(11)}{position2(11)}{onPlayerLooseSpace(11, 2)}</div></div></div>
				...
				<div className="boardsquare s15"><div id="s15div">15 <div className="backSpace">Back 3</div><div className="players">{position1(15)}{position2(15)}{onPlayerLooseSpace(15, 3)}</div></div></div>
				...
				<div className="boardsquare s19"><div id="s19div">19 <div className="loseTurn">Lose Turn</div><div className="players">{position1(19)}{position2(19)}</div></div></div>
				...
				<div className="boardsquare s22"><div id="s22div">22 <div className="backSpace">Back 4</div><div className="players">{position1(22)}{position2(22)}{onPlayerLooseSpace(22, 4)}</div></div></div>
